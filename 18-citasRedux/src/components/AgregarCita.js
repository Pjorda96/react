...
import {agregarCita, errorCita} from "../actions/citas";

class AgregarCita extends Component {

  componentDidMount() {
    this.props.errorCita(false);
  }
...
export default connect(mapStateToProps, {agregarCita, errorCita}) (AgregarCita);
